    ...
    <footer className="relative border-t border-slate-300 dark:border-surface-border py-12 backdrop-blur-lg bg-white/40 dark:bg-black/30">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg text-slate-900 dark:text-white">Lopam AI</span>
            </div>
            ...
            <div className="flex gap-4 mt-4">
              <motion.a href="#" whileHover={{ scale: 1.1 }} className="text-sm text-slate-700 dark:text-gray-200 hover:text-primary dark:hover:text-primary font-bold transition-colors">
                GitHub
              </motion.a>
              <motion.a href="#" whileHover={{ scale: 1.1 }} className="text-sm text-slate-700 dark:text-gray-200 hover:text-primary dark:hover:text-primary font-bold transition-colors">
                LinkedIn
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Features', 'Pricing', 'Security', 'Compliance'].map((item) => (
                <li key={item}>
        ...
        <div className="border-t border-slate-300 dark:border-white/20 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-slate-700 dark:text-gray-200 font-bold">© 2024 Lopam AI. All rights reserved.</p>
