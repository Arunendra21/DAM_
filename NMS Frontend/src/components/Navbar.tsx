      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 border-l border-slate-800 pl-4">
          <div className="flex flex-col text-right hidden sm:block">
            <span className="font-mono text-xs text-slate-200 font-bold leading-none">Cdr. Tripathi</span>
            <span className="font-mono text-[9px] text-cyber-blue tracking-widest uppercase mt-0.5">SECURE_OP-01</span>
          </div>
          <div className="w-8 h-8 rounded-full border border-cyber-blue/30 bg-[#0c142c] overflow-hidden flex items-center justify-center shadow-[0_0_8px_rgba(0,240,255,0.15)] select-none">
            <span className="font-orbitron font-extrabold text-[10px] text-cyber-blue">CT</span>
          </div>
        </div>
